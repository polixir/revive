...
python train.py -df data/test.npz -cf data/test.yaml -rf data/test_reward.py -vm tune -pm tune --run_id test_3 --bc_epoch 5 --ppo_epoch 5 --venv_algo bc -vgpw 0.25 -pgpw 0.25  --train_venv_trials 10 --train_policy_trials 10
