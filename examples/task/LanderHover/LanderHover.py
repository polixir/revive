...
class LanderHover(gym.Env, EzPickle):
    """
    ### Description
    ...
    def step(self, action):
        ...
        if self.render_mode == "human":
            self.render()
        return np.array(state, dtype=np.float32)[:4], reward, terminated, False, {}
...
register(
    id="LanderHover-v0",
    entry_point="LanderHover:LanderHover",
    max_episode_steps=400,
    reward_threshold=None,
)

LanderHoverEnv = gym.make("LanderHover")
